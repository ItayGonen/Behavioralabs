...
const Option = (props) => {
    ...
    const effectOnTheSelectedElement = () => {
        ...
        selectedElement.style.backgroundColor = globalStyles.ButtonsHeaderColor;
  ...
  return (
    ...
    <div 
        className={props.image? 'option-img' : props.SleepOptions? `option-${props.option.id} option-for-sleep` : `option option-${props.option.id}`}
