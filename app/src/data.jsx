export const questionsAndAnswers = [
    {
        ...
        answer: "The personality test is available in a number of different versions. It was initially used in France to identify children with developmental disabilities so that special education may be provided to them. Personality types are now being developed to help people better understand themselves and achieve their own objectives."
    }, 
    {
        id:2,
        question: "Why take a personality test?",
        answer: "The purpose of establishing your personality type is to have a better understanding of your behaviors, increase your abilities, and protect yourself from issues. Overall, research shows that knowing one's own personality types boosts long-term satisfaction."
    },
    {
        id:3,
        question: "What are the results made for?",
        answer: "We give you some insight after you take the test, and the full results are available from $19.90. We put your behavior and thoughts to the test in a number of ways, all while sticking to the essential requirements that must be met by any authentic personality test. "
    },
    {
        id:4,
        question: "How is my personality established?",
        answer: "The results are compared to those of all other test takers. It's a scientific method of finding your specific personality type and how you compare to other people."
    }, 
    {
        id:5,
        question: "Which are the best personality types?",
        answer: "Although there is no such thing as a perfect personality type, we may desire to be aware of our strengths and limits in order to better adapt and achieve our goals, depending on our social or professional environment."
    }
]
...
export const optionsForFirstTheme = [
    {
        id:1,
        text: "Strongly Agree"
    }, 
